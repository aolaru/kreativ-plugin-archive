...
export default function Home() {
  ...
  return <main>
    ...
    <section className="contribute-banner" id="contribute"><div><Bookmark size={22} /><p className="eyebrow">Keep the record accurate</p><h2>Know a release date, format,<br />or missing source?</h2></div><div><p>Pluginpedia is built one well-sourced correction at a time.</p><a href="/submit" className="button-light">Submit a plugin <ArrowRight size={16} /></a></div></section>
