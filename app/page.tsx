...
export default function Home() {
  ...
  return <main>
    <header className="site-header"><a className="wordmark" href="/"><span className="mark">A</span><span>audioplugin.io</span><small>archive</small></a><nav className={menuOpen ? 'mobile-nav open' : 'mobile-nav'} aria-label="Primary navigation"><a href="#browse">Browse</a><a href="#recent">Recent changes</a><a href="/status/discontinued">Discontinued</a><a href="#about">About</a></nav><div className="header-actions"><a className="contribute" href="/submit">Submit a plugin</a><a className="contribute" href="/admin">Editor access</a><button className="menu-button" onClick={() => setMenuOpen(!menuOpen)} aria-label="Toggle navigation">{menuOpen ? <X /> : <Menu />}</button></div></header>
    ...
    <section className="contribute-banner" id="contribute"><div><Bookmark size={22} /><p className="eyebrow">Keep the record accurate</p><h2>Know a release date, format,<br />or missing source?</h2></div><div><p>audioplugin.io is built one well-sourced correction at a time.</p><a href="/submit" className="button-light">Submit a plugin <ArrowRight size={16} /></a></div></section>
    <footer id="about"><a className="wordmark" href="/"><span className="mark">A</span><span>audioplugin.io</span><small>archive</small></a><p>A community-driven encyclopedia for audio software history.</p><div><a href="#about">About</a><a href="#guidelines">Editorial guidelines</a><a href="#sources">Sources policy</a><a href="#privacy">Privacy</a></div></footer>
  </main>;
}
